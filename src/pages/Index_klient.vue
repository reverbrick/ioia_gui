  ...
  <div class="q-pa-md">
    ...
    <q-drawer side="right" show-if-above bordered :width="280" :breakpoint="500" content-class="bg-grey-3">
      <div class="q-pa-md q-gutter-sm">
        ...
        <q-btn style="width: 250px" glossy stack color="grey" icon="attach_money" label="Budżet" @click="showMarkdown(2)" />
        ...
        <q-btn style="width: 250px" glossy stack color="grey" icon="group_work" label="Zespół wdrożeniowy" @click="showMarkdown(3)" />
      </div>
    </q-drawer>
