  ...
  <div class="q-pa-md">
    ...
    >
      <template v-slot:top-right>
        <q-btn-group rounded>
          <q-btn color="primary" rounded glossy icon="note_add" @click="popup = true" />
          <q-input borderless dense debounce="300" v-model="filter" placeholder="Search">
            <template v-slot:append>
              <q-icon name="search" />
            </template>
          </q-input>
          <q-btn color="negative" rounded glossy icon="delete" @click="remove" />
          <q-btn
            color="info"
            icon="file_copy"
            label="CSV"
            ...
            @click="csv"
          />
          <q-btn color="amber" rounded glossy icon-right="refresh" @click="refresh" />
        </q-btn-group>
      </template>
    </q-table>
